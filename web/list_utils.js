...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "pack_Pack" || nodeData.name === "batch_CreateBatch" || nodeData.name === "batch_MakeImageBatch"|| nodeData.name === "batch_MakeMaskBatch") {
        ...
        // 如果节点名称为"list_CreateList"或"list_MergeList"
        else if (nodeData.name === "list_CreateList" || nodeData.name === "list_MergeList"|| nodeData.name === "type_Anyswitch"|| nodeData.name === "type_make_condition") {
        ...
        } else if (nodeData.name == "type_AnyCast") {
            const onNodeCreated = nodeType.prototype.onNodeCreated
            nodeType.prototype.onNodeCreated = function () {
        ...
        } else if (nodeData.name === "list_ListGetByIndex" || nodeData.name === "list_ListSlice") {
            const onConnectionsChange = nodeType.prototype.onConnectionsChange
            nodeType.prototype.onConnectionsChange = function (slotType, slot, event, link_info, data) {
                const me = onConnectionsChange ? onConnectionsChange.apply(this, arguments) : undefined
                if (slotType === TypeSlot.Input) {
